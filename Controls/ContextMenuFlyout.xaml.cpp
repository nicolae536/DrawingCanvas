...
void DrawingCanvas::ContextMenuFlyout::CopyFlyoutItem_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
...
void DrawingCanvas::ContextMenuFlyout::CutFlyoutItem_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    if (_sceneComposer != nullptr)
    {
...
void DrawingCanvas::ContextMenuFlyout::PasteFlyoutItem_Click(Platform::Object^ sender, Windows::UI::Xaml::RoutedEventArgs^ e)
{
    if (_sceneComposer != nullptr)
    {
