...
winrt::Windows::Foundation::IAsyncOperation<winrt::Windows::UI::Xaml::Media::Imaging::WriteableBitmap> PlatformServices::FilePicker::PickImageAsync()
{
	...
	if (storageFile != nullptr) {
		...
		winrt::Windows::Graphics::Imaging::PixelDataProvider pixelData{ co_await decoder.GetPixelDataAsync(
			winrt::Windows::Graphics::Imaging::BitmapPixelFormat::Bgra8, // WriteableBitmap uses BGRA format 
			winrt::Windows::Graphics::Imaging::BitmapAlphaMode::Straight,
			transform,
			winrt::Windows::Graphics::Imaging::ExifOrientationMode::IgnoreExifOrientation, // This sample ignores Exif orientation 
		...
		auto m_writeableBitmap = winrt::Windows::UI::Xaml::Media::Imaging::WriteableBitmap(decoder.PixelWidth(), decoder.PixelHeight());
